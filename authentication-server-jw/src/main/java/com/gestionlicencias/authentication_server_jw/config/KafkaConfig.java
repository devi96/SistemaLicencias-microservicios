...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic usuarioAuthTopic() {
        return TopicBuilder.name("usuario-auth-creacion")
                .partitions(1)
                .replicas(1)
                .build();
    }
    // Producer config para enviar mensajes JSON
    @Bean
    ...
    @Bean
    public KafkaTemplate<String, UserCreateEvent> kafkaTemplate() {
